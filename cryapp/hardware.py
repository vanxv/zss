...
def get_disk_info():
    ...
    for physical_disk in c.Win32_DiskDrive():
        ...
        # 硬盘序列号
        print(
        'disk id:', physical_disk.SerialNumber.strip())
        tmpdict = {}
    ...
    for board_id in c.Win32_BaseBoard():
        ...
        print(
        "main board id:", board_id.SerialNumber.strip())
    ...
    for bios_id in c.Win32_BIOS():
        ...
        print(
        "bios number:", bios_id.SerialNumber.strip())
    print(
    "encrypt_str:", encrypt_str)

    # 加密算法
    print(
    zlib.adler32(encrypt_str))
    return encrypt_str
