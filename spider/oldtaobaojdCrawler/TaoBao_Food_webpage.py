...
def main():
    ...
    k_time_sleep1 = 30
    #-----------------------------------------------------------------------------------------
    download_page_fold_original = "E:\\Z_Project\\Data_Research\\TaoBao\\Webpage_Food\\"   # the fold saving all the dowloaded webpage
    #-------------------------------------------------------------------------------------------------
...
#     download_list_path = r"E:\\Z_Project\\Data_Research\\Unclassfied Webpage\\Download List\\DailyList_20160311.txt"            # the fold saving all download List and the webpage name
    download_list_path = r"E:\\Z_Project\\Data_Research\\TaoBao\\Element Infor\\TaoBao_Food_Wine_PriceComment_20160528.txt"
#     #------------------------------------------------------------------------------------------------------- 
#      
